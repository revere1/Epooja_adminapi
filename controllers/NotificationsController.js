...
//     models.notifications.findOne({ where: { id: req.params.id }, required: false }).then(notifications => {
//         let result = {};
//         if (notifications) {
//             let postData = { 'is_read': 1 }
//             notifications.updateAttributes(postData).then((updateNotifications) => {
//                 if (updateNotifications) {
//                     result.success = true;
//                     result.message = 'Notifications Updated  successfully ';
//                 } else {
//                     result.success = true;
//                     result.message = 'Notifications not Updated successfully ';
//                 }
//             })
//         }
//         else {
//             result.success = false;
//             result.message = 'Notifications not existed.';
//         }
//     });
// }
